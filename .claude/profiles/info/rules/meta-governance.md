...
✅ Do: Save plans to `.claude/session-reports/plans/YYYY-MM-DD_description.md`
...
| Session logs | ✅ Yes | .claude/session-reports/session_logs/ | ✅ Yes |
| Plans | ✅ Yes | .claude/session-reports/plans/ | ✅ Yes |
